<nav x-data="{ open: false }" class="bg-teal-500 border-b border-teal-700">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">{{ Auth::user()->{'User-Name'} }}</div>
                <div class="font-medium text-sm text-gray-500">{{ Auth::user()->{'User-Login'} }}</div>
            </div>
