    ...
    <div class="grid grid-cols-2 min-h-max">
            ...
            <div class="p-5">
                <div class="text-gray-800">
                    <div class="flex justify-between">
                        <h1><i class="uil uil-user-circle"></i> {{ $order->customer->{'Customer-Name'} }}</h1>
                        <h1><i class="uil uil-calendar-alt"></i> {{ date('d-m-Y', strtotime($order->{'Date'})) }}</h1>
                    </div>
        ...
        <div x-data="{}" class="bg-white min-h-full flex flex-col justify-between">
            <div class="py-6 sm:px-6 lg:px-8">
                ...
                <form x-ref="paymentForm" class="py-5" method="POST" action="{{ route('payment.store', ['orderId' => $order->{'Order-ID'}]) }}">
                    @csrf
                    <div class="flex justify-between items-center mb-5">
                        <h3>Metode Pembayaran</h3>
                        <div class="grid w-[28rem] grid-cols-4 space-x-1 rounded-xl bg-gray-200 py-2 px-1">
                            <div>
                                <input type="radio" name="payment_method" id="1" class="peer hidden" value="Cash" checked />
                            ...
                            <div>
                                <input type="radio" name="payment_method" id="2" class="peer hidden" value="Debit" />
                            ...
                            <div>
                                <input type="radio" name="payment_method" id="3" class="peer hidden" value="ShopeePay" />
                            ...
                            <div>
                                <input type="radio" name="payment_method" id="4" class="peer hidden" value="OVO" />
