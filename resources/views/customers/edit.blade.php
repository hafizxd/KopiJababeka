<x-app-layout>
    <x-slot name="header">
        <div class="relative">
            <div class="absolute">
                <a href="{{ route('customer.index', ['page' => request()->get('page') ?? '']) }}" class="font-bold text-white">
    ...
    <div class="grid grid-cols-3 gap-2 min-h-max">
                                            ...
                                            <tbody>
                                                @foreach ($customers as $key => $customer)
                                                    <tr class="border-b transition duration-300 ease-in-out hover:bg-neutral-100">
                                                        ...
                                                        <td class="whitespace-nowrap px-6 py-4">
                                                            <a href="{{ route('customer.edit', ['id' => $customer->{'Customer-ID'}]) }}">
        ...
        <div class="bg-white min-h-full flex flex-col justify-between">
            <div class="py-6 sm:px-6 lg:px-8">
                ...
                <form id="customerForm" class="py-10" method="POST" action="{{ route('customer.update', ['id' => $custDetail->{'Customer-ID'}]) }}">
                    @method('PUT')
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input id="id" class="block mt-1 w-full bg-gray-300" type="text" name="customer_id" value="{{ $custDetail->{'Customer-ID'} }}" required disabled />
                    ...
                    <div class="pt-5">
                        ...
                        <x-text-input id="name" class="block mt-1 w-full" type="text" name="customer_name" value="{{ $custDetail->{'Customer-Name'} }}" required autofocus />
                    ...
                    <div class="pt-5">
                        ...
                        <x-text-input id="address" class="block mt-1 w-full" type="text" name="customer_address" value="{{ $custDetail->{'Customer-Address'} }}" />
                    ...
                    <div class="pt-5">
                        ...
                        <x-text-input id="phone" class="block mt-1 w-full" type="text" name="customer_phone" value="{{ $custDetail->{'Customer-Phone'} }}" />
